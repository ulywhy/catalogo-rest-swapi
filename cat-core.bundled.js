 ...
 * http://polymer.github.io/PATENTS.txt
 */
class m{constructor(t,e,s){this.t=[],this.template=t,this.processor=e,this.options=s}update(t){let e=0;for(const s of this.t)void 0!==s&&s.setValue(t[e]),e++;for(const t of this.t)void 0!==t&&t.commit()}_clone(){const e=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),s=[],i=this.template.parts,n=document.createTreeWalker(e,133,null,!1);let o,r=0,c=0,l=n.nextNode();for(;r<i.length;)if(o=i[r],h(o)){for(;c<o.index;)c++,"TEMPLATE"===l.nodeName&&(s.push(l),n.currentNode=l.content),null===(l=n.nextNode())&&(n.currentNode=s.pop(),l=n.nextNode());if("node"===o.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(l.previousSibling),this.t.push(t)}else this.t.push(...this.processor.handleAttributeExpressions(l,o.name,o.strings,this.options));r++}else this.t.push(void 0),r++;return t&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const g=` ${s} `;class b{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",n=!1;for(let o=0;o<t;o++){const t=this.strings[o],r=t.lastIndexOf("\x3c!--");n=(r>-1||n)&&-1===t.indexOf("--\x3e",r+1);const h=l.exec(t);e+=null===h?t+(n?g:i):t.substr(0,h.index)+h[1]+h[2]+"$lit$"+h[3]+s}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const v=t=>null===t||!("object"==typeof t||"function"==typeof t),x=t=>Array.isArray(t)||!(!t||!t[Symbol.iterator]);class S{constructor(t,e,s){this.dirty=!0,this.element=t,this.name=e,this.strings=s,this.parts=[];for(let t=0;t<s.length-1;t++)this.parts[t]=this._createPart()}_createPart(){return new _(this)}_getValue(){const t=this.strings,e=t.length-1;let s="";for(let i=0;i<e;i++){s+=t[i];const e=this.parts[i];if(void 0!==e){const t=e.value;if(v(t)||!x(t))s+="string"==typeof t?t:String(t);else for(const e of t)s+="string"==typeof e?e:String(e)}}return s+=t[e],s}commit(){this.dirty&&(this.dirty=!1,this.element.setAttribute(this.name,this._getValue()))}}class _{constructor(t){this.value=void 0,this.committer=t}setValue(t){t===y||v(t)&&t===this.value||(this.value=t,f(t)||(this.committer.dirty=!0))}commit(){for(;f(this.value);){const t=this.value;this.value=y,t(this)}this.value!==y&&this.committer.commit()}}class C{constructor(t){this.value=void 0,this.s=void 0,this.options=t}appendInto(t){this.startNode=t.appendChild(c()),this.endNode=t.appendChild(c())}insertAfterNode(t){this.startNode=t,this.endNode=t.nextSibling}appendIntoPart(t){t.i(this.startNode=c()),t.i(this.endNode=c())}insertAfterPart(t){t.i(this.startNode=c()),this.endNode=t.endNode,t.endNode=this.startNode}setValue(t){this.s=t}commit(){if(null===this.startNode.parentNode)return;for(;f(this.s);){const t=this.s;this.s=y,t(this)}const t=this.s;t!==y&&(v(t)?t!==this.value&&this.o(t):t instanceof b?this.h(t):t instanceof Node?this.l(t):x(t)?this.u(t):t===w?(this.value=w,this.clear()):this.o(t))}i(t){this.endNode.parentNode.insertBefore(t,this.endNode)}l(t){this.value!==t&&(this.clear(),this.i(t),this.value=t)}o(t){const e=this.startNode.nextSibling,s="string"==typeof(t=null==t?"":t)?t:String(t);e===this.endNode.previousSibling&&3===e.nodeType?e.data=s:this.l(document.createTextNode(s)),this.value=t}h(t){const e=this.options.templateFactory(t);if(this.value instanceof m&&this.value.template===e)this.value.update(t.values);else{const s=new m(e,t.processor,this.options),i=s._clone();s.update(t.values),this.l(i),this.value=s}}u(t){Array.isArray(this.value)||(this.value=[],this.clear());const e=this.value;let s,i=0;for(const n of t)s=e[i],void 0===s&&(s=new C(this.options),e.push(s),0===i?s.appendIntoPart(this):s.insertAfterPart(e[i-1])),s.setValue(n),s.commit(),i++;i<e.length&&(e.length=i,this.clear(s&&s.endNode))}clear(t=this.startNode){e(this.startNode.parentNode,t.nextSibling,this.endNode)}}class k{constructor(t,e,s){if(this.value=void 0,this.s=void 0,2!==s.length||""!==s[0]||""!==s[1])throw new Error("Boolean attributes can only contain a single expression");this.element=t,this.name=e,this.strings=s}setValue(t){this.s=t}commit(){for(;f(this.s);){const t=this.s;this.s=y,t(this)}if(this.s===y)return;const t=!!this.s;this.value!==t&&(t?this.element.setAttribute(this.name,""):this.element.removeAttribute(this.name),this.value=t),this.s=y}}class $ extends S{constructor(t,e,s){super(t,e,s),this.single=2===s.length&&""===s[0]&&""===s[1]}_createPart(){return new j(this)}_getValue(){return this.single?this.parts[0].value:super._getValue()}commit(){this.dirty&&(this.dirty=!1,this.element[this.name]=this._getValue())}}class j extends _{}let O=!1;(()=>{try{const t={get capture(){return O=!0,!1}};window.addEventListener("test",t,t),window.removeEventListener("test",t,t)}catch(t){}})();class P{constructor(t,e,s){this.value=void 0,this.s=void 0,this.element=t,this.eventName=e,this.eventContext=s,this.p=t=>this.handleEvent(t)}setValue(t){this.s=t}commit(){for(;f(this.s);){const t=this.s;this.s=y,t(this)}if(this.s===y)return;const t=this.s,e=this.value,s=null==t||null!=e&&(t.capture!==e.capture||t.once!==e.once||t.passive!==e.passive),i=null!=t&&(null==e||s);s&&this.element.removeEventListener(this.eventName,this.p,this.m),i&&(this.m=A(t),this.element.addEventListener(this.eventName,this.p,this.m)),this.value=t,this.s=y}handleEvent(t){"function"==typeof this.value?this.value.call(this.eventContext||this.element,t):this.value.handleEvent(t)}}const A=t=>t&&(O?{capture:t.capture,passive:t.passive,once:t.once}:t.capture)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new $(t,e.slice(1),s).parts}return"@"===n?[new P(t,e.slice(1),i.eventContext)]:"?"===n?[new k(t,e.slice(1),s)]:new S(t,e,s).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
(window.litElementVersions||(window.litElementVersions=[])).push("2.3.1");const Q={};class X extends H{static getStyles(){return this.styles}static _getUniqueStyles(){if(this.hasOwnProperty(JSCompiler_renameProperty("_styles",this)))return;const t=this.getStyles();if(void 0===t)this._styles=[];else if(Array.isArray(t)){const e=(t,s)=>t.reduceRight((t,s)=>Array.isArray(s)?e(s,t):(t.add(s),t),s),s=e(t,new Set),i=[];s.forEach(t=>i.unshift(t)),this._styles=i}else this._styles=[t]}initialize(){super.initialize(),this.constructor._getUniqueStyles(),this.renderRoot=this.createRenderRoot(),window.ShadowRoot&&this.renderRoot instanceof window.ShadowRoot&&this.adoptStyles()}createRenderRoot(){return this.attachShadow({mode:"open"})}adoptStyles(){const t=this.constructor._styles;0!==t.length&&(void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?L?this.renderRoot.adoptedStyleSheets=t.map(t=>t.styleSheet):this._needsShimAdoptedStyleSheets=!0:window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t.map(t=>t.cssText),this.localName))}connectedCallback(){super.connectedCallback(),this.hasUpdated&&void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this)}update(t){const e=this.render();super.update(t),e!==Q&&this.constructor.render(e,this.renderRoot,{scopeName:this.localName,eventContext:this}),this._needsShimAdoptedStyleSheets&&(this._needsShimAdoptedStyleSheets=!1,this.constructor._styles.forEach(t=>{const e=document.createElement("style");e.textContent=t.cssText,this.renderRoot.appendChild(e)}))}render(){return Q}}X.finalized=!0,X.render=(t,s,i)=>{if(!i||"object"!=typeof i||!i.scopeName)throw new Error("The `scopeName` option is required.");const n=i.scopeName,o=T.has(s),r=V&&11===s.nodeType&&!!s.host,h=r&&!q.has(n),c=h?document.createDocumentFragment():s;if(((t,s,i)=>{let n=T.get(s);void 0===n&&(e(s,s.firstChild),T.set(s,n=new C(Object.assign({templateFactory:E},i))),n.appendInto(s)),n.setValue(t),n.commit()})(t,c,Object.assign({templateFactory:D(n)},i)),h){const t=T.get(c);T.delete(c);const i=t.value instanceof m?t.value.template:void 0;z(n,c,i),e(s,s.firstChild),s.appendChild(c),T.set(s,t)}!o&&r&&window.ShadyCSS.styleElement(s.host)};class Y{constructor(t="https://swapi.dev/api"){this.endpoint=t,this.defaultHeader={"Content-Type":"application/json"}}doGet(t,e="",s=this.defaultHeader){return console.log(t),t="https://swapi.dev/api/starships",fetch(this.endpoint+t+(""!=e?"?"+e:""),{method:"GET",mode:"cors",headers:s}).then(t=>t.json()).then(t=>(console.log(t),t)).catch(t=>console.log(t))}}window.customElements.define("cat-category-item",class extends X{static get styles(){return K`
    ...
    `}static get properties(){return{restDriver:{type:Object},categories:{type:Object}}}constructor(){super(),this.restDriver=new Y,this.setRestCategories()}setRestCategories(){this.restDriver.doGet("/").then(t=>{this.categories=Object.entries(t),console.log(this.categories)})}render(){return N`
      ...
      <slot></slot>
    `}_onClick(){this.count++}});window.customElements.define("cat-product-item",class extends X{static get styles(){return K`
      :host {
        display: flex;
        flex-direction: column;
        margin: 0;
    ...
    `}static get properties(){return{name:{type:String},link:{type:String},catDriver:{type:Object}}}constructor(){super(),this.catDriver=new Y}displayCategory(t){console.log("clicked");let e=new CustomEvent("display-category",{detail:{name:this.name,link:this.link},bubbles:!0,composed:!0});this.dispatchEvent(e)}render(){return N`product test
      <h1 @click="${this.displayCategory}">${this.name}</h1>
      <slot></slot>
    `}_onClick(){this.count++}});window.customElements.define("cat-category",class extends X{static get styles(){return K`
      :host {
        display: flex;
        margin: 0;
        background-color: palegreen;
      }
    `}static get properties(){return{category:{type:Object},restDriver:{type:Object},products:{type:Object}}}constructor(){super(),this.restDriver=new Y}setRestProducts(){console.log("setRestProducts"),this.restDriver.doGet("/"+this.category.name).then(t=>{this.products=Object.entries(t),console.log(this.products)})}displayCategory(t){let e=new CustomEvent("display-category",{detail:{name:this.name,link:this.link},bubbles:!0,composed:!0});this.dispatchEvent(e)}render(){return this.setRestProducts(),N`
        <h1>${this.category.name}</h1>
        <ul class="category-list">
         ${this.products.map(t=>N`<cat-product-item name="${t[0]}" link="${t[1]}"></cat-product-item>`)}
      </ul>
    ...
    `}static get properties(){return{name:{type:String},count:{type:Number},catDriver:{type:Object}}}constructor(){super(),this.catDriver=new Y,this.name="World",this.count=0}render(){return N`
      <h1>Hello, ${this.name}!</h1>
      <button @click=${this._onClick} part="button">
        Click Count: ${this.count}
      </button>
      <slot></slot>
    `}_onClick(){this.count++}});class Z extends X{static get styles(){return K`
      :host {
        display: flex;
        flex-direction: column;
        height: 100%;
    ...
    `}static get properties(){return{category:{type:Object},catDriver:{type:Object}}}constructor(){super(),this.catDriver=new Y}showCategory(t){console.log(t),this.category=t.detail,this.shadowRoot.getElementById("category-element").classList.remove("hidden"),this.shadowRoot.getElementById("category-element").classList.add("visible"),this.hideCategories()}hideCategory(){this.shadowRoot.getElementById("category-element").classList.add("hidden"),this.shadowRoot.getElementById("category-element").classList.remove("visible")}hideCategories(){this.shadowRoot.getElementById("categories-element").classList.add("hidden"),this.shadowRoot.getElementById("categories-element").classList.remove("visible")}render(){return N`
      ...
      <slot></slot>
    `}_onClick(){this.count++}}window.customElements.define("cat-core",Z);export{Z as CatCore};
